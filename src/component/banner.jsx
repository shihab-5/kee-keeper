    ...
    return (
       <>
        <div className='flex flex-col gap-5 items-center pt-16 bg-base-300 '>
            <h1 className='text-5xl font-bold text-emerald-800 sm:text-center sm:mx-10'>Friends to keep close in your life</h1>
            <h3 className='text-gray-800 sm:mx-10 sm:text-center'>Your personal shelf of meaningful connections. Browse, tend, and nurture the
